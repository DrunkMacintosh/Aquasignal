...
export default function AdvisorPopout({ district, onClose }) {
  return (
    <aside
      ...
      className="fixed inset-0 z-40 flex flex-col bg-surface shadow-sheet animate-fade-up md:absolute md:inset-auto md:bottom-20 md:right-[26.5rem] md:top-[5.5rem] md:w-[440px] md:rounded-2xl md:border md:border-ink/10 md:shadow-card md:animate-slide-in-right"
    >
